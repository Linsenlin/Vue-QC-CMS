<template>
  <div class="select-school">
    <search @search="searchSchool" width="100%"></search>
    <p class="reset" v-if="resetBtn" @click="reset">
      <a>重置</a>
    </p>
    <el-select v-model="schoolId" @change="changeSchool" placeholder="请搜索营区然后选择" class="w300">
      <el-option
